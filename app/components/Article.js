...
export default function Article({art, image}){ 
    ...
    return(
        <div key={art.id} class="my-0 mx-1 px-0 py-10">
             
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src={`https://hisvmczmnmlimhtxqhvl.supabase.co/storage/v1/object/public/test/articles/${art.id}`} alt="" />
                </a>
                <div class="p-5">
                    
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><Link href={`/articles/${art.id}`}>{art.title}</Link></h5>
